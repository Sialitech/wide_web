...
import { faCoffee, faBug,  faHatWizard, faFlushed, faBalanceScaleLeft, faDatabase, faCodeBranch, faFileExcel, faThList, faBook, faFlask} from '@fortawesome/free-solid-svg-icons';
